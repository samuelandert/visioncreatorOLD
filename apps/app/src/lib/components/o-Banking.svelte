...
<div class="flex flex-col w-full h-full overflow-hidden text-gray-800 bg-gray-100">
	...
	<div class="p-4 bg-blue-600">
		<div class="flex justify-center">
			<button
				on:click={sendMoney}
				class="px-6 py-2 font-semibold text-white transition duration-300 bg-blue-800 rounded-full hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-opacity-50"
			>
				Send Money
			</button>
		</div>
