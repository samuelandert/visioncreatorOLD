...
<h1
	class="h1 text-3xl @md:text-2xl @4xl:text-3xl @5xl:text-4xl @6xl:text-5xl @7xl:text-6xl text-center mb-6"
>
	{callToActionPrefix}
</h1>
<div class="px-8 py-4 mb-6 bg-opacity-40 bg-surface-800 rounded-2xl">
